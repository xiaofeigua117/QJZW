...
public class OrderUtil {
  ...
  //灯
    ...
    public static final  String light_order="FFE0";
    public static final String open_light2="0002";
    public static final String open_light3="0004";

    public static final String open_light11= "0004";
    public static final String open_light22="0002";
    public static final String open_light33="0001";

    public static final  String tong_light_order="FFF7";
    public static final  String wei_light_order="FFBF";
    public static final String open_light_tong="0008";
//    public static final String open_light_fenwei="0010";
    public static final String open_light_fenwei="0010";
    public static final String feiwei_order="FFEF";
    ...
    public static final String open_light44="0006";
    public static final String open_light55="0005";
    public static final String open_light66="0003";
    public static final String open_light77="0007";
    //public static final String open_light10="0010";
    ...
    //03 06 07 E1 00 01 02 06 00 5C C7
      public static final String open_window= "0200";

      public static final  String window_order="F9FF";
    //03 06 07 E1 00 01 02 02 00 5E 07
      public static final String close_window="0600";
    ...
    public static void senOrder2(Context contextS,int type){
        ...
        switch (type){
            //light1
            case 1:
                dataorder= CRC16M.hexString2binaryString(open_light11);
                dataBitHandl=light_order;
                break;
            //关闭窗户
            case 2:
                //light2
                dataorder= CRC16M.hexString2binaryString(open_light22);
                dataBitHandl=light_order;
                break;
            case 3:
                //light3
                dataorder= CRC16M.hexString2binaryString(open_light33);
                dataBitHandl=light_order;
                break;
            case 4:
                //light4
...
//                关窗帘
                ...
                break;
            case 15:
                byte[] mod= CRC16M.getSendBuf("060300000007");

                PLCSerialPortUtil.sendData(type,CRC16M.getBufHexStr(mod));

                Log.i("传感器--",CRC16M.getBufHexStr(mod)+"");
                //返回值类型
            ...
            case 18:
                //4级亮度
                dataorder= CRC16M.hexString2binaryString(open_light44);
                dataBitHandl=light_order;
                break;
            case 19:
                dataorder= CRC16M.hexString2binaryString(open_light55);
                dataBitHandl=light_order;
                break;
            case 20:
                dataorder= CRC16M.hexString2binaryString(open_light66);
                dataBitHandl=light_order;
                break;
            case 21:
                dataorder= CRC16M.hexString2binaryString(open_light77);
                dataBitHandl=light_order;
                break;
            case 22:
                //筒灯开
