...
import serialport_utils.FandelayThread;
            ...
            switch (msg.what) {
                case 1:
                    if (msg.obj != null) {
                        ...
                        //判断门开打开夜灯
                        if (InputStatus.door_open == 1) {
                            Send_Controller.isClicked = 2;
                            Send_Controller.send_type = 9;

                            InputStatus.door_open = 0;
                            Log.i("门开夜灯", "kai");
                        }
                        if (InputStatus.door_close == 1) {
                            Send_Controller.isClicked = 2;
                            Send_Controller.send_type = 10;
                            InputStatus.door_close = 0;
                        }
//                        //判断窗户状态
...
//                        }
                        ...
                        //判断窗帘1开启
                        if (InputStatus.Is_openCurtain1 == 1) {
                            Send_Controller.isClicked=2;
                            Send_Controller.send_type=1;
                            InputStatus.Is_openCurtain1 = 0;
                        }
                        if (InputStatus.Is_closeCurtain1 == 1) {
                            Send_Controller.isClicked=2;
                            Send_Controller.send_type=2;
                            InputStatus.Is_closeCurtain1 = 0;
                        }
                        //判断窗帘2开启
                        if (InputStatus.Is_openCurtain2 == 1) {
                            Send_Controller.isClicked=2;
                            Send_Controller.send_type=3;
                            InputStatus.Is_openCurtain2 = 0;
                        }
                        if (InputStatus.Is_closeCurtain2 == 1) {

                            Send_Controller.isClicked=2;
                            Send_Controller.send_type=4;
                            InputStatus.Is_closeCurtain2 = 0;
                        }
